...
export const selectIsLoading = (state: MainState) => state.userReducer.isLoading;
export const selectErrorMessage = (state: MainState) => state.userReducer.errorMessage;
