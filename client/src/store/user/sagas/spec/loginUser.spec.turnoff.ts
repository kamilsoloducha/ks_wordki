...
describe("loginUserEffect", () => {
  ...
  it("should call take every", () => {
    mock.mockImplementation(
      () => new Promise<ApiResponse<api.LoginResponse>>({ isCorrect: false } as any)
    );
...
describe("loginUser generator", () => {
  ...
  //     isCorrect: false,
  //     error: "",
  //     response: { id: "id", token: "token" } as api.LoginResponse,
  //   } as ApiResponse<api.LoginResponse>;
  //   mock.mockImplementation(() => new Promise<ApiResponse<api.LoginResponse>>((_, __) => response));
