...
public class OwnerIdTests
{
    ...
    {
        var guid = Guid.Empty;
        Action act = () => OwnerId.Restore(guid);
    ...
    {
        var guid = Guid.Parse("227682f3-5c39-4fff-8e4f-61880795d8f5");
        var ownerId1 = OwnerId.Restore(guid);
        var ownerId2 = OwnerId.Restore(guid);
    ...
    {
        var ownerId1 = OwnerId.Restore(Guid.Parse("227682f3-5c39-4fff-8e4f-61880795d8f5"));
        var ownerId2 = OwnerId.Restore(Guid.Parse("227682f3-5c39-4fff-8e4f-61880795d8f6"));
